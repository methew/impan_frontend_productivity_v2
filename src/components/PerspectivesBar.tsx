...
interface PerspectivesBarProps {
  ...
  onTaskPaperClick?: () => void
}

export function PerspectivesBar({ className, isAuthenticated = false, onTaskPaperClick }: PerspectivesBarProps) {
    ...
    <div className={cn("flex flex-col h-full bg-card border-r", className)}>
      ...
      <div className="p-2 border-b space-y-1">
        ...
        >
          ...
          <span className="flex-1">快速批量添加</span>
        </button>
      </div>
